...
find ./dist -type f -exec $SED_CMD -i -E "s#imports: \['(.*)\.ts(.*)'\]#imports: \['/node_modules/greenwoodspectrumtheme\1\.js\2'\]#g" {} \;
find ./dist -type f -iname '*.html' -exec $SED_CMD -i -E 's#src="/components/([^"]+)\.ts"#src="/node_modules/greenwoodspectrumtheme/components/\1\.js"#g' {} \;
